...
window.App = {
  ...
  withdrawToken: function() {
	//Write the Withdraw Token function
    /**
     * Attention!
     * The Withdraw Token function does not work like deposit token.
     *
     * You can directly "transfer" the Tokens from the Exchange to the account-holder.
     * Then reduce the balance (or reduce the balance before!)
     */
  },
  /**
